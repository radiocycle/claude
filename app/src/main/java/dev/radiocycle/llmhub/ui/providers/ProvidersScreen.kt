...
fun ProvidersScreen(viewModel: ProvidersViewModel, onEdit: () -> Unit) {
    ...
    Scaffold(
        ...
        if (providers.isEmpty()) {
            ...
            LazyColumn(
                ...
                item {
                    Text(
                        "Requests try providers top to bottom. Drag order is set with the arrows.",
    ...
    pendingDelete?.let { provider ->
        AlertDialog(
            ...
            text = { Text("The endpoint and its API key are deleted from this device.") },
            confirmButton = {
                TextButton(onClick = {
...
private fun ProviderCard(
    ...
    Surface(
        ...
        Column(Modifier.padding(start = 18.dp, end = 8.dp, top = 14.dp, bottom = 10.dp)) {
